...
//    }
    ...
    flash_write_memory(buffer, Address, Size);
...
Read(uint32_t Address, uint32_t Size, uint8_t* buffer) {
    ...
    flash_read_memory(Address, Size, buffer);
...
//    }
    ...
    flash_sector_erase(EraseStartAddress, EraseEndAddress);
...
//
    ...
    while (Size > VerifiedData) {
    	...
    	flash_read_memory(MemoryAddr + VerifiedData, 2, Buffer);
